$(window).on('load', function () {
    var testData = {
        max: 300,
        data: [
            {lat: 50.049683, lng: 19.944544, count: 30},
            {lat: 50.049682, lng: 19.944543, count: 70},
            {lat: 50.049681, lng: 19.943542, count: 10},
            {lat: 50.049079, lng: 19.940541, count: 50},
            {lat: 50.049678, lng: 19.943540, count: 10},
            {lat: 50.049677, lng: 19.944539, count: 30},
            {
                lat: 42.1818,
                lng: -71.1962,
                count: 3
    ...
    var map = new L.Map('map', {
        center: new L.LatLng(50.049683, 19.944544),
        zoom: 12,
